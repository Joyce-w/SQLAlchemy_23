...
class UsersViewsTestCase(TestCase):
    ...
    def test_new_psot(self):
        with app.test_client() as client:
            test_post = {"title": "Test Title", "content": "This is test content"}
            
            resp = client.post(f"/users/{self.user_id}/posts/new", data=test_post, follow_redirects=True)
            html = resp.get_data(as_text=True)
